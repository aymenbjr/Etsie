				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb-tree">
							<li><a href="http://localhost:8080/Etsie/Acceuil">Home</a></li>
							<li class="active">${ produit.nomPro }</li>
						</ul>
					</div>
				</div>
				<!-- /row -->
				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="product-details">
							<h2 class="product-name">${ produit.nomPro }</h2>
							<div>
							...
							<div>
					 		<h3 class="product-price">${ produit.puProd } <del class="product-old-price">${ produit.puProd + 320 }</del></h3> 
								<span class="product-available">Produit En Stock</span>
							</div>
<%-- 							<p>La Famille du Produit est: <strong>${ produit.famPro }</strong></p> --%>

							<c:if test="${idUtilisateur != null}">
								<a href="http://localhost:8080/Etsie/utilisateur_commande" class="add-to-cart">
									
									<button class="add-to-cart-btn"><i class="fa fa-user-o"></i> Commander</button>
								</a>
								<a href="https://www.youtube.com/watch?v=1wBvuZVE7FI" class="add-to-cart">
									
									<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i>Ajouter au Panier (soon) </button>
								</a>
							</c:if>
							<c:if test="${idUtilisateur == null}">
							<ul class="product-links">
								...
								<a href="http://localhost:8080/Etsie/login" class="add-to-cart">
											...
											<div id="reviews">
												<ul class="reviews">
													...
													<li>
														...
														<div class="review-body">
															<p>produits de bonne qualité, rien que parfait!</p>
														</div>
													</li>
													<li>
														<div class="review-heading">
