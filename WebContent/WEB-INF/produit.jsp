			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li class="active"><a href="http://localhost:8080/Etsie/Produit">Nos Produits</a></li>
			...
			<div class="container">
				...
				<div class="row">
						...
						<div class="aside">
							...
							<div class="product-widget">
								...
								<div class="product-body">
												<p class="product-category">3320.0</p>
												<h3 class="product-name"><a href="http://localhost:8080/Etsie/detail?id_p=4">Dell Latitude D800</a></h3>
							...
							<div class="product-widget">
								<div class="product-img">
									<img src="./img/zir.jpg"  alt="">
								</div>
								<div class="product-body">
												<p class="product-category">240.0</p>
												<h3 class="product-name"><a href="http://localhost:8080/detail/voyage?id_p=2">Palm Zire 71</a></h3>
							...
							<div class="product-widget">
								...
								<div class="product-body">
												<p class="product-category">5200.0</p>
												<h3 class="product-name"><a href="http://localhost:8080/Etsie/detail?id_p=5">Dell Latitude X1</a></h3>
					...
					<div class="col-md-4 col-xs-6">
								<div class="product">
									<div class="product-img">
									<img src="./img/cart.jpg"  height="180" alt="">
									</div>
									<div class="product-body">
									<p class="product-category">${ produit.puProd }</p> 
									<h3 class="product-name">${ produit.nomPro }</h3>
									</div>
									<div class="add-to-cart">
									<a  class="add-to-cart-btn" href="http://localhost:8080/Etsie/detail?id_p=${ produit.numPro }">Plus d'Info</a>
									</div>
								</div>
							</div>
					</c:forEach>
